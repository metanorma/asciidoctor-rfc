...
This element marks up words like MUST and SHOULD <xref target="BCP14" /> with an HTML
...
See <xref target='document-information'>"Document Information"</xref> for information on this element.
