...
* RFC XML does not require `vspace` between a definition list term and its definition.
This gem inserts a `vspace`, to comply with `idnits` requirements.
--
...
+
--
* The MMark has specifed no blank lines between definition list terms and definitions. In order to
satisfy idnits, this gem consistently inserts one blank line between definition list terms 
