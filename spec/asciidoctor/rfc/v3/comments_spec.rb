...
describe Asciidoctor::RFC::V3::Converter do
  ...
  it "uses full range of inline formatting within Asciidoc inline admonition" do
    ...
    INPUT
       ...
       <t>Text</t>
       <cref>
       Text <em>Text</em> <strong>Text</strong> <tt>Text</tt> <sub>Text</sub> <sup>Text</sup> <eref target="http://example.com/">linktext</eref> <xref target="ref">[ref]</xref> <relref relative="fragment" section="section" displayFormat="bare" target="crossreference">text</relref>
       </cref>
       </section>
       </middle><back>
