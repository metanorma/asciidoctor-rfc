...
The cache of bibliographic information is built from screenscraping the contents of:
...
The cache of current workgroups is built from screenscraping the contents of:
