...
<9> figure/artwork@align, figure/artwork@alt; figure/artwork@type (only available in v2, intended to be a MIME type; in v3, populated as either `svg` or `binary-art` depending on file suffix)
...
| http://asciidoctor.org/docs/user-manual/#images[Inline images] || Ignored
