...
A referencegroup is identified if there is a nested list of references. Note that other Asciidoc
renderers do not expect unordered lists of references to be nested, and they may have
problems rendering such nested bibliographic lists.
